...
export default function LoginMenu() {
    ...
    const getRoleColor = () => {
        switch (role) {
            ...
            case 'sub-admin': return 'bg-gray-100 text-gray-800';
    ...
    return (
        <>
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <button className="flex items-center space-x-2 group">
                        <div className="relative">
                            <div className="bg-gradient-to-br from-gray-500 to-gray-600 p-0.5 rounded-full group-hover:from-gray-600 group-hover:to-gray-700 transition-all">
                            ...
                            <div className="absolute -bottom-1 -right-1">
                                <Badge className={`${getRoleColor()} px-2 py-0.5 text-xs font-medium rounded-full capitalize`}>
                                    {role}
                                </Badge>
                            </div>
                        </div>
                ...
                >
                    {/* User profile card */}
                    <div className="bg-gradient-to-r from-gray-600 to-black/80 p-6 text-white">
